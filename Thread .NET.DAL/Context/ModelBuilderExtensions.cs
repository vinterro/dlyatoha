...
namespace Thread_.NET.DAL.Context
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void Configure(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PostDisreaction>()
                .HasAlternateKey(pr => new { pr.PostId, pr.UserId });
            ...
            modelBuilder.Entity<CommentDisreaction>()
              .HasAlternateKey(cr => new { cr.CommentId, cr.UserId });
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            var postDisreactions = GenerateRandomPostDisreactions(posts, users);


            var commentReactions = GenerateRandomCommentReactions(comments, users);
            var commentDisreactions = GenerateRandomCommentDisreactions(comments, users);
            ...
            modelBuilder.Entity<PostDisreaction>().HasData(postDisreactions);


            modelBuilder.Entity<CommentReaction>().HasData(commentReactions);
            modelBuilder.Entity<CommentDisreaction>().HasData(commentDisreactions);
        ...
        public static ICollection<Disreaction> GenerateRandomDisreactions(ICollection<User> users)
        {
            int disreactionId = 1;

            var disreactionsFake = new Faker<Disreaction>()
                .RuleFor(r => r.Id, f => disreactionId++)
                .RuleFor(r => r.IsDis, f => f.Random.Bool())
                .RuleFor(r => r.UserId, f => f.PickRandom(users).Id)
                .RuleFor(pi => pi.CreatedAt, f => DateTime.Now)
                .RuleFor(pi => pi.UpdatedAt, f => DateTime.Now);

            return disreactionsFake.Generate(ENTITY_COUNT);
        }
        ...
        public static ICollection<PostDisreaction> GenerateRandomPostDisreactions(ICollection<Post> posts, ICollection<User> users)
        {
            int postDisreactionId = 1;

            var postDisreactionsFake = new Faker<PostDisreaction>()
                .RuleFor(pr => pr.Id, f => postDisreactionId++)
                .RuleFor(cr => cr.IsDis, f => f.Random.Bool())
                .RuleFor(cr => cr.UserId, f => f.PickRandom(users).Id)
                .RuleFor(pr => pr.PostId, f => f.PickRandom(posts).Id)
                .RuleFor(pi => pi.CreatedAt, f => DateTime.Now)
                .RuleFor(pi => pi.UpdatedAt, f => DateTime.Now);

            return postDisreactionsFake.Generate(ENTITY_COUNT);
        }
        ...
        public static ICollection<CommentDisreaction> GenerateRandomCommentDisreactions(ICollection<Comment> comments, ICollection<User> users)
        {
            int commentDisreactionId = 1;

            var commentDisreactionsFake = new Faker<CommentDisreaction>()
                .RuleFor(cr => cr.Id, f => commentDisreactionId++)
                .RuleFor(cr => cr.IsDis, f => f.Random.Bool())
                .RuleFor(cr => cr.UserId, f => f.PickRandom(users).Id)
                .RuleFor(cr => cr.CommentId, f => f.PickRandom(comments).Id)
                .RuleFor(pi => pi.CreatedAt, f => DateTime.Now)
            ...
            return commentDisreactionsFake.Generate(ENTITY_COUNT);
        }
    }
